  ...
  return (
    <div className={`w-[100%] ${backgroundStyle}`}>
      {timerExpired ? (
        ...
        <div className={`${backgroundStyle2} absolute bottom-10 left-0 right-0 w-[150px] m-auto mb-0 shadow-2xl border-4 border-cyan-800 p-2 bg-black text-white rounded-xl flex flex-col justify-center`} style={{textAlign: 'center'}}>
